...
export default class AudioFile extends Component{
    ...
    //         driveImageUri:response.coverImg,
    //         driveBookUri:response.cloud_url,
    ...
    //     });
        ...
        componentDidMount(){
            ...
            .then((data)=>{
                ...
                this.setState({
                    ...
                    author:data.author,
                    genre:data.genre,
                    driveImageUri:data.coverImg,
                    driveBookUri:data.cloud_url,
        ...
        console.log("PRINTING DRIVE BOOK URI")
